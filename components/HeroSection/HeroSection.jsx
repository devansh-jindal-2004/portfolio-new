...
function HeroSection() {
    ...
    return (
        <section
            ...
            style={{
                backgroundImage: isMobile ? "url('/heroImage.png')" : "linear-gradient(to bottom, #f5f5f5, #e0e0e0)",
        ...
        >
            ...
            <div className="relative text-center sm:text-left w-full sm:w-1/2 z-10 text-white sm:text-gray-900">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold sm:font-medium leading-tight">
                    Full-Stack Developer & Mobile App Expert
                </h1>
                <p className="text-sm sm:text-lg lg:text-xl xl:text-2xl mt-3 leading-relaxed">
