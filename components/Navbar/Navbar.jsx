...
function Navbar({ setSelected, selected }) {
  ...
  return (
    <div className="absolute right-0 bottom-0 xl:top-0 bg-[#1E1E1E] shadow-lg flex  px-5 py-3 rounded-t-2xl xl:rounded-t-none xl:rounded-se-3xl xl:rounded-es-3xl bg-gray-100/5 h-fit w-full xl:w-fit justify-center items-center">
