...
function Navbar({ setSelected, selected }) {
  ...
  return (
    <div className="fixed md:absolute right-0 bottom-0 xl:top-0 bg-[#232323f2]/95 shadow-lg flex xl:px-5 py-2 xl:py-3 rounded-t-2xl xl:rounded-t-none xl:rounded-se-3xl xl:rounded-es-3xl h-fit w-full xl:w-fit justify-center items-center z-50">
